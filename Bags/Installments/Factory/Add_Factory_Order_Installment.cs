...
{
    public partial class Add_Factory_Order_Installment : Form
    {
        Controller controller;
        public Add_Factory_Order_Installment()
        {
            InitializeComponent();
        ...
        private void Add_btn_Click(object sender, EventArgs e)
        {
            ...
            if (controller.Add_Order_From_Factory_Installment(BarCode_tb.Text, Model_tb.Text, Factory_Name_tb.Text, Colors_tb.Text, quntity, price, price * quntity, Installment) == 1)
            {
