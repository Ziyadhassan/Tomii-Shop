...
{
    public partial class Still_To_Pay_To_Factroy : Form
    {
        Controller controller;
        public Still_To_Pay_To_Factroy()
        {
            InitializeComponent();
            ...
            DataTable dt = controller.Still_To_Pay_To_Factory();

            if(dt == null)
            {
                MessageBox.Show("لا توجد مدفوعات عليك");
                return;
            }
            else
            {
