...
{
    public partial class Add_Out_Normal_Installment : Form
    {
        Controller controller;
        public Add_Out_Normal_Installment()
        {
            InitializeComponent();
        ...
        private void Add_btn_Click(object sender, EventArgs e)
        {
            ...
            if (controller.Add_Order_Out_Factory_Normal(BarCode_tb.Text, Model_tb.Text, Factory_Name_tb.Text, Colors_tb.Text, quntity, price, price * quntity, Installment) == 1)
            {
