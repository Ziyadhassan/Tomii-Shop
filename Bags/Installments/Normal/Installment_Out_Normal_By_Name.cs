...
{
    public partial class Installment_Out_Normal_By_Name : Form
    {
        Controller controller;
        public Installment_Out_Normal_By_Name()
        {
            InitializeComponent();
        ...
        {
            DataTable dt = controller.Installments_Out_Normal_By_Name(textBox1.Text);
