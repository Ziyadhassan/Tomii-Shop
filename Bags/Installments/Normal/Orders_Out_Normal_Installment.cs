...
{
    public partial class Orders_Out_Normal_Installment : UserControl
    {
        Controller controller;
        public Orders_Out_Normal_Installment()
        {
            InitializeComponent();
        ...
        {
            DataTable dt = controller.Get_All_Out_Normal_Installments();
        ...
        {
            Add_Out_Normal_Installment _Form = new Add_Out_Normal_Installment();
        ...
        {
            Pay_Installment_Out_Normal pay_Installment_Out_ = new Pay_Installment_Out_Normal();
            pay_Installment_Out_.Show();
        }

        private void Show_Bu_Name_btn_Click(object sender, EventArgs e)
        {
            Installment_Out_Normal_By_Name installment_Out_By_Name = new Installment_Out_Normal_By_Name();
            installment_Out_By_Name.Show();
        }

        private void Still_to_Pay_btn_Click(object sender, EventArgs e)
        {
            Still_To_Get_Out_Normal still_To_Get_Out_ = new Still_To_Get_Out_Normal();
        ...
        {
            Delete_Order_Out_Normal_Installment delete_ = new Delete_Order_Out_Normal_Installment();
            delete_.Show();
        }
    }
}
